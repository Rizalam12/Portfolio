const portfolioData = {
  ...
  projects: {
    full: `1. CryptoTracker (React, CoinGecko API). 2. Dashboard (React, Vite). 3. Build-A-Thon 2024 (HTML/CSS/JS hackathon site). 4. FullStack Django (Django tweet app). 5. Web Scraping (BeautifulSoup/Scrapy). 6. LMS (MERN stack). 7. Ecommerce (MERN full-stack shop).`,
