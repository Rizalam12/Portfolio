...
export function Contact() {
  const { mutate, isPending, isSuccess, isError, data } = useCreateMessage();
      ...
      setToastData(
        data?.emailSent
          ...
          : {
              ...
              subMessage: "Your message was saved, but the email notification could not be sent.",
            },
      );
    }
  }, [isSuccess, data]);
  ...
  return (
    <section id="contact" className="py-16 md:py-24 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <SectionHeading 
          title="Get In Touch" 
          subtitle="Have a product idea, a role to discuss, or a project that needs a developer? I’d love to hear about it." 
        />
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="space-y-8 mb-10">
              <div className="mb-7"><p className="text-sm uppercase tracking-[.2em] text-primary mb-2">Let’s work together</p><h3 className="text-3xl font-bold text-white">Tell me what you’re building.</h3></div>
