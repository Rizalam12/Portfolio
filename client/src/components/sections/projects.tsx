...
import { ExternalLink, Code2 as Github, FolderKanban, ChevronDown, ChevronUp } from "lucide-react";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
    ...
    <section id="projects" className="py-16 md:py-24 relative bg-secondary/20">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="A selection of projects that show how I approach interfaces, APIs, data and product flows."
        />
...
function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className="group glass-card hover-glow rounded-3xl p-7 md:p-8 flex flex-col h-full relative overflow-hidden"
    >
      ...
      <div className="relative z-10 flex-grow">
        <h3 className="text-2xl md:text-[1.65rem] font-bold text-foreground mb-3 group-hover:text-primary transition-colors">
          {title}
        </h3>
